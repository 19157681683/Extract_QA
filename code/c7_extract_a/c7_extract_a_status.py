...
def process_json_file(file_path: str) -> Tuple[int, Dict[str, int]]:
    ...
    主要实现方式：
        ...
        - 遍历 JSON 对象，统计 question, check_question_can_answer, expand_question,
          check_question_is_integrity, answer 相关的指标。
        - 返回 JSON 对象总数和各指标的计数。
...
if __name__ == "__main__":
    # # window部署
    # input_directory = r"D:\Project\1. Super_Computer\2025\c03_js_wang_OpenAI_use\project-2\data\c7_extract_a"

    # linux
    input_directory = "/x32001214/project/2025/c03_js_wang_QA/project-2/data/c7_extract_a"
